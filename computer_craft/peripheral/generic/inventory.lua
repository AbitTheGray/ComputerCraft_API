...
function energy_storage.size() end
...
---@return table @All items in this inventory.
function energy_storage.list() end
...
function energy_storage.getItemDetail(slot) end
...
function energy_storage.getItemLimit(slow) end
...
---@param limit number @(OPTIONAL) The maximum number of items to move. Defaults to the current stack limit.
---@param toSlot number @(OPTIONAL) The slot in the target inventory to move to. If not given, the item will be inserted into any slot.
---@throw If the peripheral to transfer to doesn't exist or isn't an inventory.
---@throw If either source or destination slot is out of range.
---@return number @The number of transferred items.
function energy_storage.pushItems(toName, fromSlot, limit, toSlot) end
...
---@throw If either source or destination slot is out of range.
---@return number @The number of transferred items.
function energy_storage.pullItems(fromName, fromSlot, limit, toSlot) end
